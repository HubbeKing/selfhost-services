...
module.exports = {
	...
	defaults: {
		...
		realname: "Lounger",
		join: "#desertbus",
		leaveMessage: "Goodbye friends, I am gone.",
	},
	...
	ldap: {
		...
		url: "ldap://openldap.authelia.svc.cluster.local",
